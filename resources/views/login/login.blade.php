  ...
  <div class="relative py-3 sm:max-w-xl sm:mx-auto">
    ...
    <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
      ...
      <div class="w-full flex justify-center mt-4">
        <button id="BtEntrar" class="bg-cyan-500 text-white rounded-md px-2 py-1">Iniciar Sesión</button>
      </div>

      <div class="w-full flex justify-center mt-4">
      <button id="BtRegistro" class="bg-cyan-500 text-white rounded-md px-2 py-1">Registrarme</button>
      </div>
